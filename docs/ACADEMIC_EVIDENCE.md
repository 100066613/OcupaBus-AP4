...
| Documento técnico del proyecto                | Google Drive / `docs/documentacion_tecnica_AP4.md`           | Disponible                             |
| Diagrama de flujo                             | `docs/diagrama_flujo.txt`                                    | Disponible                             |
| Capturas de pantalla (navegador y emulador)   | Google Drive (no versionadas en el repositorio; 6 imágenes)  | Disponible                             |
...
## 6. Evidencias disponibles en el repositorio de Google Drive

Las siguientes capturas no se versionan en este repositorio (ver `.gitignore`) y están disponibles en el repositorio institucional de evidencias enlazado en el `README.md`:

| Imagen                                       | Descripción                                            |
| --------------------------------------------- | ------------------------------------------------------ |
| `01_navegador_conectado.png`                | App ejecutándose en navegador con conexión activa      |
| `02_navegador_offline.png`                  | App en navegador sin conexión (banner offline visible) |
| `03_emulador_conectado.png`                 | App en emulador Android con conexión activa            |
| `04_emulador_conectado_reporte_enviado.png` | Reporte enviado correctamente en emulador              |
| `05_emulador_offline.png`                   | Emulador en modo offline                               |
| `06_emulador_offline_reporte_pendiente.png` | Reporte en cola de pendientes (emulador offline)       |
